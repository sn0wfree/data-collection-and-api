...
def main():
    ...
    os.system("""(echo authenticate '"yourpassword"'; echo signal newnym; echo quit) | nc localhost 1080""")
    getip_requesocks(url)
    #main()
...
def reset_ip_address(reset=False):
    ...
    import socks
    if reset:
        os.system("""(echo authenticate '"mypassword"'; echo signal newnym; echo quit) | nc localhost 1080""")
    else:
        pass
