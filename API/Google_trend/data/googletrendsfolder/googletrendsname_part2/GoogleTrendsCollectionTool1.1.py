...
def DateProduce_backup(beginyear):
...
if __name__ == '__main__':
    ...
    #keywords=['1-800 FLOWERS COM','1ST SOURCE CORP','21ST CENTURY FOX CL A','21ST CENTURY FOX CL B','2U INC']
