...
class pyGTrends(object):
	...
	def download_report(self, keywords, date='2016-06-01%202016-12-31', geo='all', geor='all', graph = 'all_csv', sort=0, scale=0, sa='N'):
		"""
...
if __name__ == '__main__':
	...
	username = 'snowpythontest@gmail.com'
	#raw_input('Enter your Google username: \n')
	password = '19920815'
	#raw_input('Enter your Google password: \n')
